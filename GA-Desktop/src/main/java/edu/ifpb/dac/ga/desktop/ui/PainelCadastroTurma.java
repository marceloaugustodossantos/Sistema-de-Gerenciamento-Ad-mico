 ...
 */
public class PainelCadastroTurma extends javax.swing.JPanel {
    ...
    public PainelCadastroTurma(FramePrincipalAdmin framePrincipalAdmin) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cadastro de Turma");
        add(jLabel4);
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        turma.setAlunos(this.alunosTurma);
        ...
        if (validador.ehValido(turma)) {
            ...
            this.framePrincipal.setContentPane(new PainelCadastroTurma(this.framePrincipal));
